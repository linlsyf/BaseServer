...
//        courseFile=courseFile+"sql/"+ FavourCon.USER_BASE+"/Create.sql";
...
//        boolean flag=false;
//
//        String courseFile= BaseDao.getSqlFilePath(FavourCon.USER_BASE,BaseDao.LIST_TYPE);//instance 需要初始化
//        Map<String, Object> map = new HashMap<String, Object>();
...
//        boolean flag=false;
//
//        String courseFile= BaseDao.getSqlFilePath(FavourCon.USER_BASE,"Search.sql");//instance 需要初始化
////        Map<String, Object> map = new HashMap<String, Object>();
...
//
//        String courseFile =instance.getClass().getResource("").getPath() ;
//        courseFile=courseFile+"sql/"+ FavourCon.USER_BASE+"/Remove.sql";
//        Map<String, Object> map = new HashMap<String, Object>();
//
//        //json对象转Map
